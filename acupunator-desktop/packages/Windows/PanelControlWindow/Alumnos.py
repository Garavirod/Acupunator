...
class AlumnosWindow(QMainWindow):
    def __init__(self,parent=None):
        super(AlumnosWindow,self).__init__(parent)
        # Cargamos template del panel de Historiales
        loadUi('templates/Alumnos.ui',self)
    ...
    def filtrarAlumnos(self):
        ...
        if not response == RespBDD.ERROR_GET:            
            ...
            QMessageBox.warning(self, 'Estado de la petición', 'Error al cargar los alumnos', QMessageBox.Ok)            
